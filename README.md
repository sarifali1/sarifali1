...
I am a motivated **Web Developer** and **Master of Computer Applications (MCA)** student, passionate about building clean, user-friendly, and efficient web applications. I enjoy learning new technologies and strengthening my problem-solving skills through hands-on projects.
...
- **Bachelor of Computer Applications (BCA)** (2021 – 2024)  
  Murshidabad College of Engineering & Technology (MAKAUT)
...
A web-based application designed to automate and manage college operations.

**Features:**
- Student registration & course allocation  
- Timetable scheduling  
- Result management  
- Secure multi-user authentication  
- Real-time data access  

**Tech Stack:** HTML, CSS, JavaScript, Node.js, Database (MySQL/MongoDB)

---

## 📜 Certifications

- **Cloud Based Full Stack Development Using MERN**  
...
⭐ *I am actively learning, building projects, and looking for internship opportunities. Feel free to explore my repositories and connect with me!*
